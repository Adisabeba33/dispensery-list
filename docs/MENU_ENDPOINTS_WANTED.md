...
Работающих магазинов в реестре: **330**. Обход заходит в **310**, полку отдают **202**.
...
| Flynnstoned Cannabis Company ✳️ | Brooklyn | https://flynnstoned.com | товары есть (12), цветка нет |
