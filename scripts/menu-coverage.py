...
def report():
    ...
    section(
        ...
        "Число слева меню называет само. Похоже на недолистанную страницу.\n"
        "Оговорка: если магазин объявляет общий каталог, а мы читаем только\n"
        "цветок, расхождение законно — такие строки надо смотреть глазами.",
        [
