...
def build_listing(product, shop, source_url):
    ...
    if isinstance(variants, list):
        for v in variants:
            ...
            # larger format in silence. Across 9943 collected listings a 70g
            # jar appeared exactly zero times while one shop's own filter
            # counts five. The bound is the state's — three ounces, 85 grams,
            # the most an adult may buy in New York in a day.
